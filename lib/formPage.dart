...
class SecondPage extends StatefulWidget {
  ...
  final String name;
  SecondPage({Key key, this.imageURL, this.collect, this.name})
      : super(key: key);
...
class _SecondPageState extends State<SecondPage> {
          ...
          child: ListView(
            children: <Widget>[
              ...
              Row(children: <Widget>[
                ...
                Text(' Enter Valid Links or Leave Empty'),
              ]),
              Padding(
  ...
  Widget showProgress() {
    if (flag)
      ...
      return Text(
        'Submit',
        style: GoogleFonts.robotoCondensed(color: Colors.white, fontSize: 40.0),
      );
  }
